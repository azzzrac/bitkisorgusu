...
public class BitkiGUI extends JFrame {
    ...
    private final ModernButton profileButton = new ModernButton("👤 Hesabım", new Color(40, 116, 166), new Color(52, 152, 219));
    ...
    // 👤 "HESABIM" PROFİL VE ARAÇLAR PENCERESİ (Düzenli & Derli Toplu)
    private void showProfileDialog() {
        JDialog profileDialog = new JDialog(this, "👤 Hesabım & Profil Merkezi", true);
        profileDialog.setSize(640, 580);
        ...
        JLabel rankLabel = new JLabel("Unvan: " + titleRank);
        rankLabel.setFont(new Font("Segoe UI", Font.ITALIC, 13));
        ...
        for (String note : kisiselNotlar) noteModel.addElement("📌 " + note);

        JList<String> noteList = new JList<>(noteModel);
        noteList.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        noteList.setBackground(isDarkMode ? new Color(30, 42, 32) : Color.WHITE);
        noteList.setForeground(isDarkMode ? new Color(232, 245, 233) : new Color(30, 60, 35));

        JScrollPane noteScroll = new JScrollPane(noteList);
        noteScroll.setPreferredSize(new Dimension(500, 90));
        ...
        ModernButton addNoteBtn = new ModernButton("➕ Not Ekle", new Color(46, 125, 50), new Color(67, 160, 71));
        addNoteBtn.setPreferredSize(new Dimension(100, 32));
